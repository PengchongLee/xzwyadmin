...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="<?= UrlService::buildWwwUrl('/admin/images/y.jpg')?>" class="radius-circle rotate-hover" height="50" alt="" />后台管理中心</h1>
  </div>
...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="<?= UrlService::buildWwwUrl('/company/add') ?>" ><span class="icon-caret-right"></span>网站设置</a></li>
    <li><a href="pass.html" ><span class="icon-caret-right"></span>修改密码</a></li>
    <li><a href="page.html" ><span class="icon-caret-right"></span>导航管理</a></li>
    <li><a href="<?= UrlService::buildWwwUrl('/carousel/index') ?>" ><span class="icon-caret-right"></span>首页轮播</a></li>
    <li><a href="<?= UrlService::buildWwwUrl('/online/index') ?>" ><span class="icon-caret-right"></span>在线报名</a></li>
  </ul>   
